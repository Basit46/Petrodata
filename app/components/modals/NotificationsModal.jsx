  ...
  return (
    ...
    >
      <div
        ...
        } bg-black duration-500 w-[400px] h-full border-l border-l-[#404040] flex flex-col`}
      >
        <div className="w-full px-[24px] pt-[24px] pb-[20px] flex items-center justify-between">
        ...
        <div className="mx-[24px] px-[2px] h-[40px] py-[2px] border border-[#404040] rounded-[10px] flex justify-between items-center">
          <button
        ...
        <div className="noti-box pl-[24px] mr-[30px] pt-[20px] flex-1 overflow-y-auto">
        ...
        <div className="mt-auto w-full h-[84px] border-t-[0.8px] border-t-[#404040] flex justify-center items-center gap-[10px]">
          <button
            onClick={() => setShowModal("")}
            className="w-[40%] h-[36px] bg-[#525252] rounded-[16px] border border-[#737373] text-[14px] font-[500]"
          >
            Close
          </button>
          <button
            onClick={markAllAsRead}
            className="w-[40%] h-[36px] bg-[#00897B] rounded-[16px] border border-[#00897B] text-[14px] font-[500] flex items-center justify-center gap-[5px]"
          >
