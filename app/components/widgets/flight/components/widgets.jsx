  ...
  return (
    <div className="small flex flex-col">
      <div className="flex items-center gap-[5px] py-[10px] px-[16px]">
        ...
        <p className="text-[12px] font-gray">Flights</p>
      </div>
...
export const MediumWidget = () => {
  ...
  return (
    <div className="medium flex flex-col xmd:flex-row">
      ...
      <div className="bg-[#404040] flex-1 h-full py-[20px] px-[10px] space-y-[20px] rounded-r-[12.4px]">
...
export const LargeWidget = () => {
  ...
  return (
    <div className="large flex flex-col">
      ...
      <div className="w-full bg-[#404040] flex-1 py-[20px] px-[10px] space-y-[20px] rounded-b-[12.4px]">
        {airportData.map((airport, i) => (
          <div key={i} className="w-full flex justify-between items-center">
            ...
            <p className="w-[35%] text-[12px] text-[#D4D4D4] text-end">
              {airport.flights} flights
            </p>
          </div>
        ))}
