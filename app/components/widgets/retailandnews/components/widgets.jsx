...
export const SmallWidget = () => {
  return (
    <div className="small p-[16px] flex flex-col justify-between gap-[10px]">
      ...
      <div className="flex-1 w-full flex items-center justify-center">
        <PriceChart data={PMSWeekData} chartHeight={140} xlabel />
      </div>
      ...
      <div className="h-fit">
        {news
          ...
          .map((item, i) => (
            <div
              key={i}
              className="flex pt-[5px] pb-[10px] px-[10px] gap-[10px]"
            >
...
export const MediumWidget = () => {
  return (
    <div className="medium py-[10px]">
      <div className="w-full h-fit px-[16px] py-[5px] flex justify-between gap-[10px] items-center">
        <div className="">
          <div className="flex items-center gap-[4px]">
            <Trend
              size={10}
...
export const LargeWidget = () => {
  return (
    <div className="large py-[10px]">
      <div className="w-full h-fit py-[5px] px-[16px] flex justify-between gap-[10px] items-center">
        <div className="">
          <div className="flex items-center gap-[4px]">
            <Trend
              size={10}
